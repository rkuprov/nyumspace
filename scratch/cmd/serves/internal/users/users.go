...
import (
	...
	sql2 "github.com/rkuprov/nyumspace/scratch/cmd/serves/internal/sql"
...
func (u *Users) RegisterUser(
	...
	err = u.DB.QueryRow(ctx, sql2.RegisterUser, id, req.Username, req.Email, string(hash)).Scan(&registeredID)
	if err != nil {
		return nil, err
	}
	if registeredID != id {
...
func (u *Users) checkEmailExists(ctx context.Context, email string) (bool, error) {
	var exists bool
	err := u.DB.QueryRow(ctx, sql2.CheckEmailExists, email).Scan(&exists)
	switch {
	case err == nil:
		return exists, nil
...
func (u *Users) GetUser(ctx context.Context, req *nyum.UserRequest) (*nyum.UserResponse, error) {
	row := u.DB.QueryRow(ctx, sql2.GetUser, req.UserId)
...
func (u *Users) UpdateUser(ctx context.Context, req *nyum.UserUpdateRequest) (*nyum.UserUpdateResponse, error) {
	...
	err = u.DB.QueryRow(ctx, sql2.UpdateUser,
		req.UserID,
		req.Username,
		req.Email,
...
func (u *Users) DeleteUser(ctx context.Context, req *nyum.UserDeleteRequest) (*nyum.UserDeleteResponse, error) {
	...
	_, err := u.DB.Exec(ctx, sql2.DeleteUser, req.UserId)
	if err != nil {
...
func (u *Users) LoginUser(ctx context.Context, req *nyum.UserLoginRequest) (*nyum.UserLoginResponse, error) {
	...
	row := u.DB.QueryRow(ctx, sql2.GetUserByEmail, req.Email)
	...
	_, err := u.DB.Exec(ctx, sql2.CreateSession, sessionToken, userID, expiresAt)
	if err != nil {
...
func (u *Users) LogoutUser(ctx context.Context, req *nyum.UserLogoutRequest) (*nyum.UserLogoutResponse, error) {
	...
	_, err := u.DB.Exec(ctx, sql2.DeleteSession, req.SessionToken)
	if err != nil {
